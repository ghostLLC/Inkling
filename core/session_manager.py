...
业务逻辑已下沉到 app/application/handlers/
"""
import uuid
from typing import Optional, Dict, Any

from core.state_machine import StateMachine, SessionState, TaskMode
from core.stuck_classifier import StuckClassifier
from core.guide_generator import GuideGenerator
from core.content_guard import ContentGuard, OutputLimiter
from core.llm_provider import LLMProvider

from app.application.handlers.topic_analysis import TopicAnalysisHandler
from app.application.handlers.stuck_rescue import StuckRescueHandler
from app.application.handlers.ending_guide import EndingGuideHandler
from app.application.handlers.complete import CompleteHandler
