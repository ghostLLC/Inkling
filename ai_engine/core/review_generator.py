...
class ReviewGenerator:
    ...
    def _find_session(self, session_id: str) -> WritingSession | None:
        return next((s for s in self.sessions if s.session_id == session_id), None)

    def _get_previous_session(self, session_id: str) -> WritingSession | None:
    ...
    def _suggest_training(self, type_distribution: Counter) -> str | None:
        if not type_distribution:
            return None
